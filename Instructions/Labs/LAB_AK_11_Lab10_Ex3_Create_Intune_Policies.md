...
2. In your **Edge** browser,  open for the **Microsoft Endpoint manager Admin center** Https://Endpoint.microsoft.com. 
...
16. In the the **Microsoft Endpoint manager Admin center**, in the left-hand navigation pane, select **Azure Active Directory.**
